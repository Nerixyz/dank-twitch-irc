...
Deno.test("validateChannelName rejects undefined", function() {
  assertThrowsChain(
...
Deno.test("validateChannelName rejects null", function() {
  assertThrowsChain(
...
Deno.test("validateChannelName rejects empty strings", function() {
  assertThrowsChain(
    () => validateChannelName(""),
    ValidationError,
...
Deno.test("validateChannelName allows single letters", function() {
...
Deno.test("validateChannelName allows underscores", function() {
...
Deno.test("validateChannelName rejects uppercase letters", function() {
  assertThrowsChain(
...
Deno.test("validateChannelName allows ID 0", function() {
  validateChannelName("chatrooms:0:85c31777-b181-46ab-8e08-73e4ecd7a386");
});
Deno.test("validateChannelName doesn't allow no user ID", function() {
  assertThrowsChain(
    () =>
      validateChannelName(
...
Deno.test("validateChannelName allows ID 123", function() {
  validateChannelName("chatrooms:1:85c31777-b181-46ab-8e08-73e4ecd7a386");
});
Deno.test("validateChannelName allows random normal ID from a real user", function() {
  validateChannelName(
    "chatrooms:11148817:85c31777-b181-46ab-8e08-73e4ecd7a386",
  );
});
Deno.test("validateChannelName allows different UUIDs", function() {
  validateChannelName(
...
Deno.test("validateChannelName allows maximum 64 bit integer user ID", function() {
  validateChannelName(
    "chatrooms:9223372036854775807:85c31777-b181-46ab-8e08-73e4ecd7a386",
  );
});
Deno.test("validateChannelName doesn't allow capizalization in \"chatrooms\"", function() {
  assertThrowsChain(
    () =>
      validateChannelName(
        "Chatrooms:11148817:85c31777-b181-46ab-8e08-73e4ecd7a386",
...
Deno.test("validateChannelName doesn't allow capizalization in the UUID", function() {
  assertThrowsChain(
    () =>
      validateChannelName(
        "chatrooms:11148817:85C31777-B181-46AB-8E08-73E4ECD7A386",
...
Deno.test("validateChannelName doesn't allow non-hex characters in the UUID", function() {
  assertThrowsChain(
    () =>
      validateChannelName(
...
Deno.test("validateChannelName doesn't allow non-dashes in the UUID", function() {
  assertThrowsChain(
    () =>
      validateChannelName(
...
Deno.test("validateChannelName doesn't allow partial matches", function() {
  assertThrowsChain(
    () =>
      validateChannelName(
